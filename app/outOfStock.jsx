      ...
      <Card.Content style={styles.cardContent}>
        <View style={styles.productInfo}>
          ...
          <View style={styles.productDetails}>
            ...
            <Badge style={[styles.stockBadge, { backgroundColor: '#F44336' }]}>
              Out of stock
            </Badge>
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={[styles.emptyText, { color: theme.colors.onSurfaceVariant }]}>
              {searchQuery ? "No matching out of stock items" : "No out of stock products"}
            </Text>
          </View>
        }
      />
      ...
      <Modal visible={buyModalVisible} transparent animationType="fade">
        <View style={styles.modalBackdrop}>
          <View style={[styles.modalContainer, { backgroundColor: theme.colors.surface }]}>
            ...
            <Text style={[styles.modalSubtitle, { color: theme.colors.error }]}>
              {selectedProduct?.name} (Currently out of stock)
            </Text>
...
// Reuse the same styles from LowStockScreen
